...
(function () {
  ...
  var PLANS = {
    free: {
      ...
      price: 0,
      period: 'forever',
      tagline: 'Try it out — 2 sheets/day, no watermark, AI BG included.',
      features: [
        '5 photos per sheet',
    ...
    weekly: {
      ...
      price: 59,
      period: '/week',
      tagline: '7 days full access, no watermark.',
      features: [
        'Unlimited photos',
        'No watermark',
        'All country presets',
        'Priority AI BG removal',
        'HD 600 DPI export'
      ]
    },
    monthly: {
      ...
      price: 149,
      period: '/month',
      tagline: 'Best value. 30 days, everything unlocked.',
      features: [
  ...
  function ensureModals() {
    ...
    wrap.innerHTML = [
      ...
      '        Unlimited passport photos, no watermark, HD export, all country presets.<br>',
      '        <span class="accent">Cancel anytime · No hidden fees · Secure payments</span>',
      '      </div>',
