...
Last PR: PR #211 (docs: mark PVC tray shipped PR #210, add §R section, update prompt)

Shipped summary (don't redo):
PRs #70–#211: all previous work shipped
...
- PR #211: docs — mark PVC tray shipped, add §R, update prompt
