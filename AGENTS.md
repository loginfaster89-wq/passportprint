...
**Also resolved (PRs #118–#168):** PRs #118–#132 stats-grid slider,
...
PR #167 Photo Only dynamic photo detection. PR #168 PAN-specific
card crop + photo detection (per-doc-type crops, x-scan 22% for PAN).
